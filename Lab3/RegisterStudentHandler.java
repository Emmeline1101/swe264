...
public class RegisterStudentHandler extends CommandEventHandler {
    ...
    protected String execute(String param) {
        ...
        // Create a CourseConflictChecker instance and check for conflicts.
        CourseConflictChecker conflictChecker = new CourseConflictChecker(this.objDataBase);
        if (conflictChecker.checkConflict(sSID, objCourse)) {
